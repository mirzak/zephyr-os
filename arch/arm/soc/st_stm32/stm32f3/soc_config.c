...
static const stm32_pin_func_t pin_pa9_funcs[] = {
	[STM32F3_PINMUX_FUNC_PA9_USART1_TX - 1] = STM32F3X_PIN_CONFIG_AF_PUSH_PULL,
};

static const stm32_pin_func_t pin_pa10_funcs[] = {
	[STM32F3_PINMUX_FUNC_PA9_USART1_TX - 1] = STM32F3X_PIN_CONFIG_BIAS_HIGH_IMPEDANCE,
};

static const stm32_pin_func_t pin_pa2_funcs[] = {
	[STM32F3_PINMUX_FUNC_PA2_USART2_TX - 1] = STM32F3X_PIN_CONFIG_AF_PUSH_PULL,
};

static const stm32_pin_func_t pin_pa3_funcs[] = {
	[STM32F3_PINMUX_FUNC_PA3_USART2_RX - 1] = STM32F3X_PIN_CONFIG_BIAS_HIGH_IMPEDANCE,
};

static const stm32_pin_func_t pin_pb10_funcs[] = {
	[STM32F3_PINMUX_FUNC_PB10_USART3_TX - 1] = STM32F3X_PIN_CONFIG_AF_PUSH_PULL,
};

static const stm32_pin_func_t pin_pb11_funcs[] = {
	[STM32F3_PINMUX_FUNC_PB11_USART3_RX - 1] = STM32F3X_PIN_CONFIG_BIAS_HIGH_IMPEDANCE,
};
